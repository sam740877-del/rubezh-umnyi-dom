...
def secret_key() -> bytes:
    ...
    try:
        ...
        # Файл ключа не должен попасть в репозиторий: зная его, любой
        # подделает себе печенье администратора. Он вписан в .gitignore,
        # но полагаться только на это нельзя — файл однажды туда уже попал.
        print(
            f"Создан новый ключ подписи сеансов: {path.name}. "
